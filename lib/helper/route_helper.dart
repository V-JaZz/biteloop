...
import 'package:efood_multivendor/view/screens/coupon/coupon_subscribe_screen.dart';
...
import 'package:efood_multivendor/view/screens/scratcher/scratcher_viewer_screen.dart';
...
class RouteHelper {
  ...
  //subscribe
  static String getCouponSubscribeRoute({required bool fromCheckout}) =>
      '$subscribeCoupon?fromCheckout=${fromCheckout ? 'true' : 'false'}';
  ...
  static List<GetPage> routes = [
    ...
    GetPage(
        name: subscribeCoupon,
        page: () => getRoute(CouponSubscribeScreen(
            fromCheckout: Get.parameters['fromCheckout'] == 'true'))),
    ...
    GetPage(
        ...
        page: () => getRoute(OrderSuccessfulScreen(
              ...
              totalAmount: double.parse(Get.parameters['amount']!),
            ))),
    GetPage(
        name: payment,
