...
class RestaurantDescriptionView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(children: [
      ...
      Row(children: [
        ...
        InkWell(
          onTap: () {
            ...
            if (restaurant.latitude != null && restaurant.longitude != null) {
              ...
              //   openLocation(double.parse(restaurant.latitude!),
              //       double.parse(restaurant.longitude!));
            }
          },
          child: Column(children: [
        ...
        (restaurant.delivery == true && restaurant.freeDelivery == true)
            ? Expanded(child: SizedBox())
            : SizedBox(),
        (restaurant.delivery == true && restaurant.freeDelivery == true)
            ? Column(children: [
  ...
  // openLocation(double endLatitude, double endLongitude) async {
  ...
  //   launchGoogleMapsDirections(latitude, longitude, endLatitude, endLongitude);
  // }
  //
  // void launchGoogleMapsDirections(double startLatitude, double startLongitude,
