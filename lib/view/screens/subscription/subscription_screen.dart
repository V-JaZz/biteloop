...
import 'package:efood_multivendor/view/screens/subscription/subscription_checkout_screen.dart';
                              ...
                              children: [
                                ...
                                Flexible(
                                  child: TextButton(
                                    child: Container(
                                      color:
                                          weekend ? Colors.orange : Colors.grey,
                                      padding: const EdgeInsets.symmetric(
                                          vertical: 10, horizontal: 15),
                                      child: const Text(
                                        'Weekend',
            ...
            Container(
              ...
              child: CustomButton(
                  ...
                  onPressed: () async {
                    ...
                    List dayList = getDaysInBetween(
                        DateTime.parse(dateFromInput.text.toString()),
                        DateTime.parse(dateToInput.text.toString()));
                    List newDate = [];
                    ...
                    if (newDate.length == 0) {
                      var snackBar = SnackBar(
                        content: Text(
                            'Date range not detecting at least one date !'),
                        backgroundColor: Colors.red,
                        padding: EdgeInsets.all(10),
                        behavior: SnackBarBehavior.floating,
                        // shape: StadiumBorder(),
                    ...
                    if (!finalError) {
                      ...
                      print(
                          '${total} Navigate to proceed to check out ########################################################');
                    }
                  }),
            ),
          ],
