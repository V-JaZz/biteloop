...
import 'package:efood_multivendor/data/model/body/place_subscribe_body.dart';
...
class _SubscriptionCheckoutScreenState
  ...
  void initState() {
    ...
    if (_isLoggedIn == true) {
      ...
      Get.find<RestaurantController>()
          .initCheckoutData(widget.product.restaurantId);
      getToken();
    }
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: CustomAppBar(title: 'Subscription Checkout'.tr),
              ...
              return GetBuilder<RestaurantController>(
                ...
                return GetBuilder<CouponController>(
                  ...
                  return GetBuilder<OrderController>(
                    ...
                    if (restController.restaurant != null) {
                      // _price = _price + (widget.product.price * widget.product.quantity);
                      _price = widget.total;
                      ...
                      _discount = _discount +
                          ((widget.product.price -
                              PriceConverter.convertWithDiscount(
                                  widget.product.price, _dis, _disType)));
                                ...
                                child: Center(
                                  ...
                                  child: Column(
                                      ...
                                      children: [
                                        ...
                                        Text(
                                            'Delivery Dates (${widget.selectedDate.length})'),
                                        Container(
                                          height: 30,
                                    ...
                                    ? CustomButton(
                                        ...
                                        onPressed: () {
                                          ...
                                          if (_isCashOnDeliveryActive == false &&
                                            ...
                                            // List<Cart> carts = [widget.product];
                                            ...
                                            orderController.placeSubscribeOrder(
                                                PlaceSubscribeBody(
                                                  productId: widget.product.id,
                                                  qty: widget.qty,
                                                  selectedDate:
  ...
  void _callback(
    ...
    if (isSuccess) {
      ...
      if (Get.find<OrderController>().paymentMethodIndex == 0 ||
        ...
        double? finalMoney =
            Get.find<OrderController>().trackModel?.orderAmount;
        print(
            'FINAL MONEY ---------------------------------------------------');
        print(finalMoney);
        print(amount);
        print(
            'FINAL MONEY ---------------------------------------------------');
        Get.offNamed(
            RouteHelper.getOrderSuccessRoute(orderID, 'success', finalMoney!));
      } else {
        if (GetPlatform.isWeb) {
          // double finalMoney = Get.find<OrderController>().trackModel.orderAmount;
          Get.back();
