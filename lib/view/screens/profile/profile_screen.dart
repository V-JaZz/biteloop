  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: GetBuilder<UserController>(builder: (userController) {
        return (_isLoggedIn == true && userController.userInfoModel == null)
                ...
                circularImage: Container(
                  ...
                  child: ClipOval(
                    ...
                    image:
                        ...
                        '/${(userController.userInfoModel != null && _isLoggedIn == true) ? userController.userInfoModel?.image : ''}',
                    height: 100,
                    width: 100,
                    fit: BoxFit.cover,
                  )),
                    ...
                    child: Center(
                      ...
                      child: Column(children: [
                        ...
                        _isLoggedIn == true
                            ...
                            : SizedBox(),
                        SizedBox(height: _isLoggedIn == true ? 30 : 0),
                        ProfileButton(
