...
class AppConstants {
  static const String APP_NAME = 'Biteloop';
  static const double APP_VERSION = 5.7;

  // static const String BASE_URL = 'https://houseofdelivery.in/Admin';
  static const String BASE_URL = 'https://biteloop.com';
  ...
  static const String PLACE_ORDER_SUBSCRIBE_URI = '/api/v1/customer/order/place/subscribe';
  ...
  static const String COUPON_SUBSCRIBE_URI = '/api/v1/coupon/subscription';
